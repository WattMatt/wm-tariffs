...
import { formatDateStringToLong, extractDateFromTimestamp } from "@/lib/utils";
                ...
                <div key={run.id} className="flex items-center space-x-3 p-3 rounded-lg border hover:bg-muted/50">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      {formatDateStringToLong(extractDateFromTimestamp(run.date_from))} - {formatDateStringToLong(extractDateFromTimestamp(run.date_to))}
                    </p>
                  </div>
